...
export const PROJECTS = [
  ...
  },
  {
    ...
    description:
      "Developed a high-end website for THE WHITE CAMEL to present luxury desert experiences, integrating a refined layout, reservation requests, and performance best practices.",
  ...
  },
   {
    ...
    description:
     "Delivered an optimized website for Sahara Services as a tour and desert-experience provider, combining a modern interface, itinerary pages, and an easy request-to-book path.",
  ...
  
   {
    title: "GHAZALA CAMPS ",
    description:
       "Built a visually rich site for Ghazala Camps to promote luxury desert stays, featuring immersive galleries, clear pricing/amenities, and fast page loads for conversions.",
  ...
  },
  {
    ...
    description:
      "Developed a premium web presence for Morocco Luxury Camps with a photo-led design, structured tour/camp pages, and technical SEO to target high-intent keywords.",
  ...
  },
  {
  ...
  },
   {
    ...
    description:
      "Produced an elegant website for Morocco Luxury Experience to promote bespoke travel and upscale stays, with refined UI, streamlined booking requests, and SEO tuning.",
  ...
  },
  {
    ...
    description:
     "Designed a polished site for Erg Chebbi Luxurycamps spotlighting premium tents and activities, featuring fast loading, clear CTAs, and optimized metadata.",
  ...
  },
  {
    ...
    description:
      "Developed a modern website for Aliya Luxury Appart with a property-first layout, availability/contact flows, and performance and SEO enhancements for organic reach.",
